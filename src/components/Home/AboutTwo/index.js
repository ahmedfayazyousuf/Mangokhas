...
const AboutTwo = () => {
    ...
    return (
        ...
        <h1 className='HeaderText' style={{color: '#d49400', border: '3px solid #d49400', zIndex: '1', position: 'absolute', background: '#000', padding: '5px 30px 5px 30px', width: '95%', maxWidth: '800px', textAlign: 'center'}}>Pure <span className='fontSpecial' style={{color: '#fff'}}>Delight </span> in Every Mango & Pickle</h1>
            ...
            <div className='makeColumn' style={{display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', margin: '20px 0px', backgroundColor: '#000'}}>
                ...
                <div className='hoverbw rightAboutTwo' style={{ backgroundImage: `url('${Pickles}')`, backgroundPosition: 'left', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
                </div>
