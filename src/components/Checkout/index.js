...
const Checkout = () => {
  ...
  return (
    <>
    <Navbar />
        <div style={{width: '100vw', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'black', flexDirection: 'column', paddingTop: '100px', paddingBottom: '100px'}}>
